...
/*
	...
	You can inherit multiple interfaces also but only inherit from one abstract class
	 ...
	 I'd return a positive number if the current animal was less than the other animal
	 and a negative number if the current animal was more than the other animal.
