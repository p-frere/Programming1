...
public class Tester {
	...
	public static void testPart3() {
		...
		System.out.println("* Creating a new Door");
		Door door = new Door();
		System.out.println("* Setting name to Reaserch Labs");
		door.setRoomName("Research Labs");
		System.out.println("* Creating a new CardLock");
		CardLock myLock = new CardLock();
		System.out.println("* Attaching CardLock to door");
		door.attachLock(myLock);
		System.out.println();
		
		System.out.println("* Creating a new Student Card");
		SmartCard cardA = new SmartCard("Anna Undergrad");
		System.out.println("Is " + cardA.getOwner() + " staff? " + cardA.isStaff());
		System.out.println("* Swiping " + cardA.getOwner() + "'s card");
		myLock.swipeCard(cardA);
		door.openDoor();
		System.out.println();
		
		System.out.println("* Creating a new Staff Card");
		SmartCard cardB = new SmartCard("Dr. Bob Lecturer");
		cardB.setStaff(true);
		System.out.println("Is " + cardB.getOwner() + " staff? " + cardB.isStaff());
		System.out.println("* Swiping " + cardB.getOwner() + "'s card");
		myLock.swipeCard(cardB);
		door.openDoor();
	}
